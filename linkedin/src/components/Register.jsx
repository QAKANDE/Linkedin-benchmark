...
export default class signin extends Component {
    ...
    render() {
        return (
            <Container className="container-fluid" style={{ maxWidth: "100%", maxHeight: "100%", background: "#067DA6", margin: "auto" }}>
                <Row>
                    < Col lg={{ span: 6, offset: 3 }} className="text-center">
                        <img
                            ...
                            alt=""
                        />
                        <h3 className="mt-3 mb-3" style={{ color: "white" }}>Make the most of your professional life</h3>
                    </Col>
                </Row >
                    ...
                    <Col md={{ span: 4, offset: 4 }} className="text-center" style={{ backgroundColor: "#EDF0F3" }}>
                        <Form>
                            <Form.Row className="mt-1">
                                <Form.Group as={Col} controlId="formGridName">
                                    <Form.Label style={{ fontSize: "14px", margin: "0 0 0px" }}></Form.Label>
                            ...
                            <Form.Group className="mt-0" controlId="formGridBio1">
                                <Form.Label style={{ fontSize: "14px", margin: "0 0 0px" }}></Form.Label>
                            ...
                            <Form.Row className="mt-0">
                                ...
                                <Form.Group as={Col} controlId="formGridArea">
                                    <Form.Label style={{ fontSize: "14px", margin: "0 0 0px" }}></Form.Label>
                                    <Form.Control as="select" required defaultValue="Choose Area">
                            ...
                            <Form.Row className="mb-1 mt-0">
                                ...
                                <Form.Group>
                                    <Form.File
                                        style={{ margin: "0 0 0 0.35rem", width: "12rem", fontSize: "15px" }}
                                        required
                                        name="file"
                                        label=""
                        ...
                        <div className="mt-4" style={{ fontWeight: "500", color: "#0A66C2", fontSize: "17px" }}>
                            <p className="mt-3" style={{ fontWeight: "350" }}>
                                Already in LinkedIn?<Link to={"/signin"} className="button secondary text-center" style={{ fontWeight: "500", color: "#0A66C2", fontSize: "17px" }} > Sign In.</Link>
                            </p>
                        </div>
